                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="{{ route('registro.save') }}" method="POST" class="user">
    @csrf
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            <input type="text" name="name" class="form-control form-control-user" placeholder="First Name" value="{{ old('name') }}">
        </div>
        <div class="col-sm-6">
